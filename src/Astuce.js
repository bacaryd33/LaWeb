                ...
                <div className="row">
                    <div className="col-md-12">
                            ...
                            <div className="item active">
                                <div className="row">
                                <div className="col-md-3"><p>Aide étudiant</p><a href="#" className="thumbnail"><img id="imgbox"src="../images/aide.png"/></a>
                        ...
                        <a href="http://www.univ-tlse2.fr/accueil/vie-des-campus/services-numeriques/aide-etudiant-210957.kjsp">Université Toulouse II aide étudiant</a>
                                ...
                                <div className="col-md-3"><p>Aladin</p><a href="#" className="thumbnail"><img id="imgbox"src="../images/alladin.png" alt="Image"/></a>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-12">
                            ...
                            <div className="item active">
                                <div className="row">
                                <div className="col-md-3"><p>Calc</p><a href="#" className="thumbnail"><img id="imgbox"src="../images/calc.jpg" alt="Image"/></a></div>
                                </div>{/*.row*/}
                            </div>{/*.item*/}
                    </div>
                </div>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-12">
                            ...
                            <div className="item active">
                                <div className="row">
                                <div className="col-md-3"><p>Espaces de travail</p><a href="#" className="thumbnail"><img id="imgbox"src="../images/secu.png" alt="Image"/></a></div>
                                <div className="col-md-3"><p>Site aide</p><a href="http://mass-cara2.univ-tlse2.fr/~massi.ouldrabah/Vulgarisation/Page/index.html" className="thumbnail"><img id="imgbox"src="../images/cybersecurite.jpg" alt="Image"/></a></div>
                                </div>{/*.row*/}
                            </div>{/*.item*/}
                    </div>
                </div>
